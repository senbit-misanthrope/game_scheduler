    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto bg-zinc-950 min-h-screen text-zinc-200 font-sans selection:bg-red-900 selection:text-white">
      <div className="sticky top-0 z-40 bg-zinc-950 border-b-2 border-zinc-800 pb-4 pt-4 mb-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex flex-wrap gap-2 items-center justify-center">
          ...
          {/* ✨ 추가: 정사각형 느낌의 소셜 아이콘 영역 (디스코드 + 카카오톡) */}
          <div className="flex gap-2 ml-1">
            ...
            <a href="https://open.kakao.com/o/g6Ed6UPh" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#FEE500] hover:bg-[#F4DC00] rounded-lg shadow-sm transition flex items-center justify-center text-[#3A1D1D]" title="카카오톡 오픈채팅">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M8 0C3.582 0 0 2.82 0 6.3c0 2.247 1.516 4.225 3.86 5.378-.184.662-.667 2.404-.716 2.593-.062.242.083.24.234.14 1.18-.77 2.805-1.923 3.32-2.316.425.044.863.068 1.302.068 4.418 0 8-2.82 8-6.3S12.418 0 8 0z"/>
              </svg>
            </a>
          </div>
