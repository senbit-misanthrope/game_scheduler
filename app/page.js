    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto bg-zinc-950 min-h-screen text-zinc-200 font-sans selection:bg-red-900 selection:text-white">
      <div className="sticky top-0 z-40 bg-zinc-950 border-b-2 border-zinc-800 pb-4 pt-4 mb-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex flex-wrap gap-2 items-center justify-center">
          ...
          {/* ✨ 수정: 디스코드 공식 화이트 풀 로고 이미지 삽입 */}
          <a href="https://discord.gg/WhSn6M6fGM" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 bg-[#5865F2] hover:bg-[#4752C4] border-2 border-[#5865F2] hover:border-[#4752C4] rounded-lg shadow-sm transition flex items-center justify-center">
            <img src="https://assets-global.website-files.com/6257adef93867e50d84d30e2/636e0a6a4928b4e760d00617_logo_clyde_white_RGB.svg" alt="Discord" className="h-4 md:h-[18px] object-contain" />
          </a>
