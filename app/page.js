    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto bg-zinc-950 min-h-screen text-zinc-200 font-sans selection:bg-red-900 selection:text-white">
      <div className="sticky top-0 z-40 bg-zinc-950 border-b-2 border-zinc-800 pb-4 pt-4 mb-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex flex-wrap gap-2 items-center justify-center">
          ...
          {/* ✨ 수정: 내장 SVG 아이콘 + 텍스트 "Discord" 조합으로 절대 깨지지 않게 변경! */}
          <a href="https://discord.gg/WhSn6M6fGM" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-[#5865F2] hover:bg-[#4752C4] border-2 border-[#5865F2] hover:border-[#4752C4] text-white rounded-lg text-sm font-black shadow-sm transition flex items-center justify-center gap-1.5">
            ...
            <span className="text-[15px] tracking-wide mt-[1px]">Discord</span>
          </a>
